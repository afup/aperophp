...
class Comment implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        // ** Add a comment
        // *******
        $controllers->post('{id_drink}/create.html', function(Request $request, $id_drink) use ($app)
        {
            $oDrink = Model\Drink::findOneById($app['db'], $id_drink);
            ...
            if ($form->isValid())
            {
                ...
                return $request->isXmlHttpRequest() ? 'redirect' : $app->redirect($app['url_generator']->generate('_showdrink', array('id' => $id_drink)));
            }
