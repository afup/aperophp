...
ALTER TABLE Drink MODIFY member_id int(11) NULL;
ALTER TABLE Drink ADD meetup_com_id INT(11) DEFAULT NULL AFTER longitude;

ALTER TABLE User ADD meetup_com_id INT(11) DEFAULT NULL AFTER member_id;

ALTER TABLE Drink ADD meetup_com_event_url VARCHAR(255) DEFAULT NULL AFTER meetup_com_id;
