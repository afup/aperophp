...
sed -i '' -e "s!import \"!import \"../vendor/twbs/bootstrap/less/!" -e 's!vendor/twbs/bootstrap/less/sprites.less";!vendor/FortAwesome/Font-Awesome/less/font-awesome.less";!' $MAINDIR/tmp/bootstrap.less
echo -e "@import \"../assets/apero.less\";" >> $MAINDIR/tmp/bootstrap.less
sed -i '' -e "s!import \"!import \"../vendor/twbs/bootstrap/less/!" $MAINDIR/tmp/responsive.less
